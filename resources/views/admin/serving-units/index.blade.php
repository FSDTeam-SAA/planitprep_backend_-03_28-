                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.serving-units') }}">Serving Unit</a></li>
            ...
            <div class="col-sm-12">
                <div class="card ">
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.serving-units.create') }}" class="btn btn-primary d-inline-flex align-item-center float-end">
                            <i class="ti ti-plus f-18"></i> Add Serving Unit
                        </a>
                    </div>
                    <div class="card-body">
...
<script type="text/javascript">
    var table = $('#jsource-table').DataTable({
        ajax: "{{ route('admin.serving-units') }}",
        processing: true,
        serverSide: true,
        deferRender: true,
        order: [
        ...
        swalWithBootstrapButtons
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "{{ route('admin.serving-units.destroy') }}",
                        type: 'POST',
                        data: {
                            "ids": ids
                        },
    ...
    $(document).on('click', '.active', function() {
        ...
        swalWithBootstrapButtons
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('admin.serving-units.updateActive') }}",
                        type: 'POST',
                        data: {
                            id: id,
                            value: val
