        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        @if($action == 'Edit')
                        <form class="" role="form" id="edit_form" action="{{ route('admin.meal-plans.update',$record->id) }}" method="post">
                            @else
                            <form class="" method="POST" id="add_form" action="{{ route('admin.meal-plans.store') }}">
                                @endif
                                @csrf
                                <div class="row">
