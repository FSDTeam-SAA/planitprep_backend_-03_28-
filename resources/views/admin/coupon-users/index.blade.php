            ...
            <div class="col-sm-12">
                <div class="card ">
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.coupon-users.create') }}" class="btn btn-primary d-inline-flex align-item-center float-end">
                            <i class="ti ti-plus f-18"></i> Assign User
                        </a>
                    </div>
                    <div class="card-body">
...
<script type="text/javascript">
        ...
        swalWithBootstrapButtons
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "{{ route('admin.coupon-users.destroy') }}",
                        type: 'POST',
                        data: {
                            "ids": ids
                        },
    ...
    // active
    $(document).on('click', '.record_active', function() {
        ...
        swalWithBootstrapButtons
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('admin.coupon-users.updateActive') }}",
                        type: 'POST',
                        data: {
                            id: id,
                            value: val
