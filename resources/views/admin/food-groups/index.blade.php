            ...
            <div class="col-sm-12">
                <div class="card ">
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.food-groups.create') }}" class="btn btn-primary d-inline-flex align-item-center float-end">
                            <i class="ti ti-plus f-18"></i> Add Food Group
                        </a>
                    </div>
                    <div class="card-body">
        ...
        swalWithBootstrapButtons
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "{{ route('admin.food-groups.destroy') }}",
                        type: 'POST',
                        data: {
                            "ids": ids
                        },
    ...
    $(document).on('click', '.active', function() {
        ...
        swalWithBootstrapButtons
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('admin.food-groups.updateActive') }}",
                        type: 'POST',
                        data: {
                            id: id,
                            value: val
