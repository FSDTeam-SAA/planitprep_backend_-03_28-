                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.diet-types') }}">Diet Types</a></li>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        @if($action == 'Edit')
                        <form class="" role="form" id="edit_form" action="{{ route('admin.diet-types.update',$record->id) }}" method="post" enctype="multipart/form-data">
                            @else
                            <form class="" method="POST" id="add_form" action="{{ route('admin.diet-types.store') }}" enctype="multipart/form-data">
                                @endif
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-12  mb-3">
                                        <label class="form-label" for="image">Image/Lottie Animation</label>
                                        <input type="file" class="form-control" id="image" name="image" aria-label="file example">
                                        @error('image')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                        @if(isset($record->image) && $record->image!="")
                                        @php $image=$record->image @endphp
                                        @else
                                        @php $image='' @endphp
                                        @endif
