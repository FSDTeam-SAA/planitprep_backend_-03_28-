        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        @if($action == 'Edit')
                        <form class="" role="form" id="edit_form" action="{{ route('admin.exercise-plan-days.update',$record->id) }}" method="post" enctype="multipart/form-data">

                            @else
                            <form class="" method="POST" id="add_form" action="{{ route('admin.exercise-plan-days.store') }}" enctype="multipart/form-data">
                                @endif
                                @csrf
                                <div class="row">
