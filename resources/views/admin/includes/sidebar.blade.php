    <nav class="pc-sidebar">
        <div class="navbar-wrapper">
            <div class="m-header">
                <a class="navbar-brand w-100" href="{{ route('home') }}" class="b-brand text-primary" target="_blank">
                    <img src="{{ $logo }}" class="img-fluid logo-lg" alt="logo">
                </a>
            </div>
            <div class="navbar-content mt-5">
                <ul class="pc-navbar mt-4">
                    <li class="pc-item">
                    ...
                    <li class="pc-item pc-hasmenu">
                        <a href="javascript:void()" class="pc-link"><span class="pc-micon">
                                <svg class="pc-icon">
                                    <use xlink:href="#custom-menu"></use>
                                </svg> </span><span class="pc-mtext">Content</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
                        <ul class="pc-submenu">
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.serving-units') }}">Serving Units</a></li>
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.activity-levels') }}">Activity Levels</a></li>
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.goals') }}">Goals</a></li>
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.allergens') }}">Allergens</a></li>
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.diet-types') }}">Diet Types</a></li>
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.packages') }}">Packages</a></li>
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.features') }}">Features</a></li>
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.services') }}">Services</a></li>
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.meals') }}">Meals</a></li>
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.meal-plans') }}">Meal Plans</a></li>
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.medical-issues') }}">Medical Issues</a></li>
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.food-groups') }}">Food Groups</a></li>
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.food-items') }}">Food Items</a></li>
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.exercise-plan-days') }}">Excercise Plan Days</a></li>
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.coupons') }}">Coupons</a></li>
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.coupon-users.index') }}">Coupon Users</a></li>

                            <li class="pc-item pc-hasmenu">
                                <a href="#!" class="pc-link">
                                    <span class="pc-mtext">Supplements</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span>
                                </a>
                                <ul class="pc-submenu">
                                    <li class="pc-item"><a class="pc-link" href="{{ route('admin.supplement-types') }}">Types</a></li>
                                    <li class="pc-item"><a class="pc-link" href="{{ route('admin.supplements') }}">Supplements</a></li>
                                </ul>
                            </li>
                    ...
                    <!-- <li class="pc-item pc-hasmenu">
                        <a href="#!" class="pc-link">
                            ...
                            <span class="pc-mtext">Food Items</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
                        <ul class="pc-submenu">
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.food-items') }}">List</a></li>
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.food-items.create') }}">Add</a></li>
                        </ul>
                    </li> -->
                    ...
                    <li class="pc-item pc-hasmenu">
                        <a href="javascript:void()" class="pc-link"><span class="pc-micon">
                                ...
                                </svg> </span><span class="pc-mtext">Memberships</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
                        <ul class="pc-submenu">
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.memberships') }}">Memberships</a></li>
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.expired-memberships') }}">Expired Memberships</a></li>
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.expiring-memberships') }}">Expiring Memberships</a></li>
                        </ul>
                    </li>


                    <li class="pc-item">
                        <a href="{{ route('admin.testimonials') }}" class="pc-link">
                            <span class="pc-micon">
                                <svg class="pc-icon">
                    ...
                    <li class="pc-item">
                        <a href="{{ route('admin.manage-homepage') }}" class="pc-link">
                            <span class="pc-micon">
                                <svg class="pc-icon">
                                    <use xlink:href="#custom-home"></use>
                                </svg>
                            </span>
                            <span class="pc-mtext">Manage Homepage</span>
                        </a>
                    </li>

                    {{-- <li class="pc-item">
                        <a href="{{ route('admin.newsletter') }}" class="pc-link">
                    <span class="pc-micon">
                        <svg class="pc-icon">
                            <use xlink:href="#custom-message-2"></use>
                        </svg>
                    </span>
                    <span class="pc-mtext">Newsletter Template</span>
                    </a>
                    </li> --}}

                    <li class="pc-item">
                        <a href="{{ route('admin.pages.index') }}" class="pc-link">
                            <span class="pc-micon">
                                <svg class="pc-icon">
                    ...
                    <li class="pc-item pc-hasmenu">
                        <a href="javascript:void()" class="pc-link">
                            <span class="pc-micon">
                                <svg class="pc-icon">
                                    <use xlink:href="#custom-setting-2"></use>
                                </svg>
                            </span>
                            <span class="pc-mtext">Settings</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
                        <ul class="pc-submenu">
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.settings') }}">Basic</a></li>
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.chatgptSettings') }}">Open AI</a></li>
                            <li class="pc-item"><a class="pc-link" href="{{ route('admin.loginSettings') }}">Login</a></li>
                    ...
                    <li class="pc-item pc-hasmenu">
                        <a href="#!" class="pc-link"><span class="pc-micon">
                                ...
                                </svg> </span><span class="pc-mtext">Icons</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
                        <ul class="pc-submenu">
