        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        @if($action == 'Edit')
                        <form class="" role="form" id="edit_form" action="{{ route('admin.packages.update',$record->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id" value="{{$record->id}}">
                            @else
                            <form class="" method="POST" id="add_form" action="{{ route('admin.packages.store') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        @php $price='' @endphp
                                        @endif
                                        <input type="text" class="form-control  @error('price') is-invalid  @enderror" id="price" name="price" placeholder="Price" value="{{ $price }}">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <label class="form-label" for="name">Discounted Price</label>
                                        @if(isset($record->discounted_price))
                                        @php $discounted_price=$record->discounted_price @endphp
                                        @elseif(old('discounted_price'))
                                        @php $discounted_price=old('discounted_price') @endphp
                                        @else
                                        @php $discounted_price='' @endphp
                                        @endif
                                        <input type="text" class="form-control  @error('discounted_price') is-invalid  @enderror" id="discounted_price" name="discounted_price" placeholder="Discounted Price" value="{{ $discounted_price }}">
                                    ...
                                    <div class="col-md-12 form-group">
                                        ...
                                        <textarea name="description" class="form-control ckeditor" placeholder="Description">{!! old('description', $description) !!}</textarea>
                                    </div>
