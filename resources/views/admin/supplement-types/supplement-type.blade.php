                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.supplement-types') }}">Supplement Types</a></li>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        @if($action == 'Edit')
                        <form class="" role="form" id="edit_form" action="{{ route('admin.supplement-types.update',$record->id) }}" method="post" enctype="multipart/form-data">
                            @else
                            <form class="" method="POST" id="add_form" action="{{ route('admin.supplement-types.store') }}" enctype="multipart/form-data">
                                @endif
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-12  mb-3">
                                        ...
                                        @php $image=asset(Storage::url('public/allergens')).'/'.$record->image @endphp
                                        @else
                                        @php $image='' @endphp
                                        @endif
