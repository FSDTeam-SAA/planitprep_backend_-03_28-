            ...
            <div class="col-sm-12">
                <div class="card ">
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.coupons.create') }}" class="btn btn-primary d-inline-flex align-item-center float-end">
                            <i class="ti ti-plus f-18"></i> Add Coupon
                        </a>
                    </div>
                    <div class="card-body">
    ...
    $(document).on('click', '.active', function() {
        ...
        swalWithBootstrapButtons
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('admin.coupons.updateActive') }}",
                        type: 'POST',
                        data: {
                            id: id,
                            value: val
