            ...
            <div class="col-sm-12">
                <div class="card ">
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.add-service') }}" class="btn btn-primary d-inline-flex align-item-center float-end" data-bs-original-title="Add new service." data-bs-toggle="tooltip">
    ...
    $(document).on('click', '.active_item', function() {
        ...
        swalWithBootstrapButtons
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('admin.service.updateActive') }}",
                        type: 'POST',
                        data: {
                            id: id,
                            value: val
